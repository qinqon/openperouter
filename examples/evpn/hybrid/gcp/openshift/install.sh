...
kubectl -n openperouter-system wait --for condition=established --timeout=60s crd/l2vnis.network.openperouter.io
kubectl -n openperouter-system wait --for condition=established --timeout=60s crd/l3vnis.network.openperouter.io
kubectl -n openperouter-system wait --for condition=established --timeout=60s crd/underlays.network.openperouter.io
